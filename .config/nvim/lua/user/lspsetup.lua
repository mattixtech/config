...
local function lsp_keymaps(bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "n", "gX", '<cmd>lua vim.lsp.codelens.run()<CR>', opts)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>ri", "<cmd>RustToggleInlayHints<cr>", opts)
  vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>rm", "<cmd>RustExpandMacro<cr>", opts)
